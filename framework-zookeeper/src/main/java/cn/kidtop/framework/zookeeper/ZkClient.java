package cn.kidtop.framework.zookeeper;

import cn.kidtop.framework.zookeeper.exception.ZkClientException;
import cn.kidtop.framework.zookeeper.listener.Listener;
import cn.kidtop.framework.zookeeper.listener.StateListener;
import cn.kidtop.framework.zookeeper.lock.HALock;
import cn.kidtop.framework.zookeeper.lock.Lock;
import cn.kidtop.framework.zookeeper.lock.SimpleLock;
import cn.kidtop.framework.zookeeper.watcher.WatcherProcess;
import cn.kidtop.framework.zookeeper.watcher.ZkWatcher;
...
public class ZkClient {
    ...
    public byte[] getData(String path, boolean watcher) throws ZkClientException {
        ...
        try {
            ...
            throw new ZkClientException("getData node " + path, e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    public void setData(String path, byte[] data) throws ZkClientException {
        ...
        try {
            ...
            throw new ZkClientException("setData node " + path, e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    public List<String> getChild(String path, boolean watcher) throws ZkClientException {
        ...
        try {
            ...
            throw new ZkClientException("getChildren node " + path, e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    public String create(String path, byte[] data, CreateMode mode) throws ZkClientException {
        ...
        try {
            ...
            throw new ZkClientException("create node " + path + ", mode=" + mode.name(), e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
        return createNode;
    }
    ...
    public String create(String path, CreateMode mode) throws ZkClientException {
        if (path != null && !path.trim().equals("")) {
            if (exists(path)) {
                throw new ZkClientException("Node path: " + path + " already exists.", ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
            }
    ...
    public void delete(String path) throws ZkClientException {
        ...
        try {
            ...
            throw new ZkClientException("delete node " + path, e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    /**
     * 监听孩子节点数据变化 TODO  产生的节点数据监听暂时还没有取消
     *
     * @param path 父节点地址
     */
    ...
    /**
     * 目前只支持2种zookeeper状态 1. KeeperState.Expired 会话重连后 2.
     * KeeperState.Disconnected 连接断开时
     *
     * @param state
     */
    public void listenState(KeeperState state, StateListener listener) {
        if (state.getIntValue() == KeeperState.Expired.getIntValue()) {
            ...
            throw new ZkClientException("Listener state not is Expired or Disconnected.", ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    private synchronized void connection() throws ZkClientException {
        if (this.checkConnection()) {
            throw new ZkClientException("Has been connected to the server, please do not repeat connection. host:"
                    + hosts, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        ...
        try {
            ...
            throw new ZkClientException("Connect zookeeper fail, hosts=" + hosts, e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
        try {
            ...
            if (!isConn) {
                ...
                throw new ZkClientException("zookeeper connection timeout. host: " + hosts, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
            }
        } catch (InterruptedException e) {
            throw new ZkClientException("connection lock exceprion.", e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    public void close() throws ZkClientException {
        try {
            ...
            throw new ZkClientException("close zookeeper client error.", e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    public boolean exists(String path) throws ZkClientException {
        ...
        try {
            ...
            throw new ZkClientException("exists node " + path, e, ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
    }
    ...
    public boolean checkStatus() throws ZkClientException {
        if (zk == null) {
            throw new ZkClientException("Not connected to the zookeeper server,host=" + hosts
                    + ",invoking this.connect().", ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
        }
        if (zk.getState().isAlive() && this.isConnection()) {
            return true;
        }
        throw new ZkClientException("Not connected to the zookeeper server,host=" + hosts + ",state: " + zk.getState(), ZkClientException.CustomizeMessageEnum.BASECODE_EXCEPTION);
    }
    ...
    /**
     * 获取主从锁，获取到锁的进程将一直持有该锁 直到该进程死掉，其它进程才能重新争夺该锁
     *
