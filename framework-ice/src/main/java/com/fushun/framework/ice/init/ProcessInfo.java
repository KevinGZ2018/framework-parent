...
import com.fushun.framework.ice.constant.MagicData;
import com.fushun.framework.ice.exception.ProcessInfoException;
import com.fushun.framework.ice.exception.RedirectSystemOutException;
import com.fushun.framework.ice.exception.UnknownRPCServiceExcepton;
import com.fushun.framework.util.util.DateUtil;
import com.fushun.framework.util.util.Help;
...
public class ProcessInfo {
    ...
    private static void redirectSystemOut() {
        ...
        if (StringUtils.isNotEmpty(path)) {
            ...
            if (out.exists()) {
                out.renameTo(new File(path + '.' + DateUtil.getDateStr(new Date(), DateUtil.FORMAT_DATE_STR8)));
                out = new File(path);
            }
            try {
                out.createNewFile();
                ...
                throw new RedirectSystemOutException(e, RedirectSystemOutException.Enum.REDIRECT_SYSTEM_OUT_EXCEPTION);
            }
        }
    }
    ...
    private static void extractAnnotationInitClass() {
        ...
        if (StringUtils.isNotEmpty(className)) {
            try {
                ...
                throw new ProcessInfoException(e, ProcessInfoException.Enum.PROCESS_INFO_EXCEPTION);
            }
        }
    }
    ...
    private static int getWriteBuffer(String bufKey, int defaultValue) {
        ...
        if (StringUtils.isEmpty(bufSize)) {
            return defaultValue;
    ...
    /**
     * 获取IceServiceName,如："loginServiceImpl"
     * app.ice.service.name
     *
     * @return
     */
    ...
    /**
     * 获取iceserviceType  Class.forName
     * app.ice.service.type
     *
     * @return
     */
    ...
    public static Class<Ice.Object> getAppIceServiceType() {
        ...
        if (StringUtils.isNotEmpty(className)) {
            try {
                ...
                throw new UnknownRPCServiceExcepton(e, UnknownRPCServiceExcepton.Enum.UNKNOWN_EXCEPTION);
            }
        }
        return null;
    }
